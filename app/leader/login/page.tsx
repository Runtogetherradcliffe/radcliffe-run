  ...
  return (
    <div style={{
      ...
      <div style={{ width: '100%', maxWidth: 400 }}>
        ...
        <p style={{ textAlign: 'center', fontSize: 12, color: 'var(--faint)', letterSpacing: '0.08em', textTransform: 'uppercase', marginBottom: 36 }}>
          Run leader access
        </p>
        ...
        <div style={{ background: 'var(--card)', border: '1px solid var(--border)', borderRadius: 16, padding: 36 }}>
          {sent ? (
            <div style={{ textAlign: 'center' }}>
              ...
              <p style={{ fontSize: 'var(--text-base)', color: 'var(--muted)', lineHeight: 1.7 }}>
                We&apos;ve sent a login link to <strong style={{ color: 'var(--dim)' }}>{email}</strong>. Tap it to open the emergency contact lookup.
              </p>
