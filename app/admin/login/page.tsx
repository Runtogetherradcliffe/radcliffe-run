          ...
          {step === 'email' ? (
            <>
              ...
              <form onSubmit={handleSendCode} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
                <div>
                  <label style={{ display: 'block', fontSize: 12, fontWeight: 500, color: 'var(--muted)', marginBottom: 6, fontFamily: 'Inter, sans-serif' }}>
                    Email address
                  </label>
                  <input
                    type="email"
                ...
                {error && <p style={{ fontSize: 'var(--text-sm)', color: '#e05252', fontFamily: 'Inter, sans-serif' }}>⚠️ {error}</p>}
            ...
            <>
              ...
              <p style={{ fontSize: 'var(--text-sm)', color: 'var(--muted)', marginTop: 20, textAlign: 'center', fontFamily: 'Inter, sans-serif' }}>
                Wrong email?{' '}
                <button
